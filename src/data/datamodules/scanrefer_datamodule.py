...
from src.data.components.scanrefer_dataset import ScanReferDataset
...
def collate_fn(examples):
    try:
        ...
        text_token = [example["text_token"] for example in examples]
...
class ScanReferDataModule(LightningDataModule):
    def __init__(
        self,
